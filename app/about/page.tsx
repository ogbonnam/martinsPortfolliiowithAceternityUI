      ...
      <div className="bg-white text-black text-center justify-between pt-28 pb-28">
          <div className='flex gap-14'>    
              ...
              <div className='flex flex-col w-4/5 mx-auto pr-12'>
                  <h1 className='text-5xl font-bold text-left pt-11 pb-8'>OGBONNA MARTINS</h1>
                  <h3 className='text-3xl text-left pb-11'>I'm <span className='text-red-700'>Ogbonna Martins</span>, a web developer, mobile application developer, networks operations engineer and cloud engineer.
